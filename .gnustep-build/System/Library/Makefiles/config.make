...
OPTFLAG  = -D__GNU_LIBOBJC__=1
OBJCFLAGS= -D__GNU_LIBOBJC__=1 -fgnu-runtime
OBJC_LIB_FLAG = -lobjc-gnu
CPPFLAGS = -D__GNU_LIBOBJC__=1 -I/opt/homebrew/Cellar/gcc/15.2.0_1/lib/gcc/current/gcc/aarch64-apple-darwin25/15/include-gnu-runtime -I/opt/X11/include -I/opt/homebrew/include -I/opt/homebrew/opt/icu4c/include -I/opt/homebrew/opt/libxml2/include -I/opt/homebrew/opt/libffi/include
...
LD = $(CC)
LDOUT =
LDFLAGS = -L/tmp/gnustep-objc-shim.j19HPb -Wl,-rpath,/opt/homebrew/Cellar/gcc/15.2.0_1/bin/../lib/gcc/current/gcc/aarch64-apple-darwin25/15/../../.. -L/opt/homebrew/Cellar/gcc/15.2.0_1/bin/../lib/gcc/current/gcc/aarch64-apple-darwin25/15/../../.. -L/opt/X11/lib -L/opt/homebrew/lib -L/opt/homebrew/opt/icu4c/lib -L/opt/homebrew/opt/libxml2/lib -L/opt/homebrew/opt/libffi/lib -shared-libgcc 
...
INSTALL		= /opt/homebrew/bin/ginstall -c -p
