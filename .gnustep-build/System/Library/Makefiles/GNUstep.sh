...
if [ -z "$GNUSTEP_CONFIG_FILE" ]; then
  GNUSTEP_CONFIG_FILE=/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/etc/GNUstep/GNUstep.conf
else
...
if [ "$GNUSTEP_MAKE_STRICT_V2_MODE" = "yes" ]; then
  ...
  if [ -z "$GNUSTEP_SYSTEM_ROOT" ]; then
    GNUSTEP_SYSTEM_ROOT=/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System
  fi

  # This is deprecated and will be removed
  if [ -z "$GNUSTEP_LOCAL_ROOT" ]; then
    GNUSTEP_LOCAL_ROOT=/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local
  fi

  # This is deprecated and will be removed
  if [ -z "$GNUSTEP_NETWORK_ROOT" ]; then
    GNUSTEP_NETWORK_ROOT=/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Network
  fi
...
if [ -z "$GNUSTEP_MAKEFILES" ]; then
  GNUSTEP_MAKEFILES=/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Library/Makefiles
fi
...
if [ -z "" ]; then
  GNUSTEP_HOST=aarch64-apple-darwin25.3.0
  GNUSTEP_HOST_CPU=aarch64
  GNUSTEP_HOST_VENDOR=apple
  GNUSTEP_HOST_OS=darwin25
fi
