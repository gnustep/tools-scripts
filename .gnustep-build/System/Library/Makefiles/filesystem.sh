...
if [ -z "$GNUSTEP_SYSTEM_APPS" ]; 
 then GNUSTEP_SYSTEM_APPS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Applications"
fi
if [ -z "$GNUSTEP_SYSTEM_ADMIN_APPS" ]; 
 then GNUSTEP_SYSTEM_ADMIN_APPS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Applications/Admin"
fi
if [ -z "$GNUSTEP_SYSTEM_WEB_APPS" ]; 
 then GNUSTEP_SYSTEM_WEB_APPS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Library/WebApplications"
fi
if [ -z "$GNUSTEP_SYSTEM_TOOLS" ]; 
 then GNUSTEP_SYSTEM_TOOLS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Tools"
fi
if [ -z "$GNUSTEP_SYSTEM_ADMIN_TOOLS" ]; 
 then GNUSTEP_SYSTEM_ADMIN_TOOLS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Tools/Admin"
fi
if [ -z "$GNUSTEP_SYSTEM_LIBRARY" ]; 
 then GNUSTEP_SYSTEM_LIBRARY="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Library"
fi
if [ -z "$GNUSTEP_SYSTEM_HEADERS" ]; 
 then GNUSTEP_SYSTEM_HEADERS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Library/Headers"
fi
if [ -z "$GNUSTEP_SYSTEM_LIBRARIES" ]; 
 then GNUSTEP_SYSTEM_LIBRARIES="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Library/Libraries"
fi
if [ -z "$GNUSTEP_SYSTEM_DOC" ]; 
 then GNUSTEP_SYSTEM_DOC="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Library/Documentation"
fi
if [ -z "$GNUSTEP_SYSTEM_DOC_MAN" ]; 
 then GNUSTEP_SYSTEM_DOC_MAN="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Library/Documentation/man"
fi
if [ -z "$GNUSTEP_SYSTEM_DOC_INFO" ]; 
 then GNUSTEP_SYSTEM_DOC_INFO="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Library/Documentation/info"
fi
...
if [ -z "$GNUSTEP_NETWORK_APPS" ]; 
 then GNUSTEP_NETWORK_APPS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Applications"
fi
if [ -z "$GNUSTEP_NETWORK_ADMIN_APPS" ]; 
 then GNUSTEP_NETWORK_ADMIN_APPS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Applications/Admin"
fi
if [ -z "$GNUSTEP_NETWORK_WEB_APPS" ]; 
 then GNUSTEP_NETWORK_WEB_APPS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/WebApplications"
fi
if [ -z "$GNUSTEP_NETWORK_TOOLS" ]; 
 then GNUSTEP_NETWORK_TOOLS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Tools"
fi
if [ -z "$GNUSTEP_NETWORK_ADMIN_TOOLS" ]; 
 then GNUSTEP_NETWORK_ADMIN_TOOLS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Tools/Admin"
fi
if [ -z "$GNUSTEP_NETWORK_LIBRARY" ]; 
 then GNUSTEP_NETWORK_LIBRARY="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library"
fi
if [ -z "$GNUSTEP_NETWORK_HEADERS" ]; 
 then GNUSTEP_NETWORK_HEADERS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Headers"
fi
if [ -z "$GNUSTEP_NETWORK_LIBRARIES" ]; 
 then GNUSTEP_NETWORK_LIBRARIES="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Libraries"
fi
if [ -z "$GNUSTEP_NETWORK_DOC" ]; 
 then GNUSTEP_NETWORK_DOC="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Documentation"
fi
if [ -z "$GNUSTEP_NETWORK_DOC_MAN" ]; 
 then GNUSTEP_NETWORK_DOC_MAN="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Documentation/man"
fi
if [ -z "$GNUSTEP_NETWORK_DOC_INFO" ]; 
 then GNUSTEP_NETWORK_DOC_INFO="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Documentation/info"
fi
...
if [ -z "$GNUSTEP_LOCAL_APPS" ]; 
 then GNUSTEP_LOCAL_APPS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Applications"
fi
if [ -z "$GNUSTEP_LOCAL_ADMIN_APPS" ]; 
 then GNUSTEP_LOCAL_ADMIN_APPS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Applications/Admin"
fi
if [ -z "$GNUSTEP_LOCAL_WEB_APPS" ]; 
 then GNUSTEP_LOCAL_WEB_APPS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/WebApplications"
fi
if [ -z "$GNUSTEP_LOCAL_TOOLS" ]; 
 then GNUSTEP_LOCAL_TOOLS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Tools"
fi
if [ -z "$GNUSTEP_LOCAL_ADMIN_TOOLS" ]; 
 then GNUSTEP_LOCAL_ADMIN_TOOLS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Tools/Admin"
fi
if [ -z "$GNUSTEP_LOCAL_LIBRARY" ]; 
 then GNUSTEP_LOCAL_LIBRARY="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library"
fi
if [ -z "$GNUSTEP_LOCAL_HEADERS" ]; 
 then GNUSTEP_LOCAL_HEADERS="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Headers"
fi
if [ -z "$GNUSTEP_LOCAL_LIBRARIES" ]; 
 then GNUSTEP_LOCAL_LIBRARIES="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Libraries"
fi
if [ -z "$GNUSTEP_LOCAL_DOC" ]; 
 then GNUSTEP_LOCAL_DOC="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Documentation"
fi
if [ -z "$GNUSTEP_LOCAL_DOC_MAN" ]; 
 then GNUSTEP_LOCAL_DOC_MAN="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Documentation/man"
fi
if [ -z "$GNUSTEP_LOCAL_DOC_INFO" ]; 
 then GNUSTEP_LOCAL_DOC_INFO="/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local/Library/Documentation/info"
fi
