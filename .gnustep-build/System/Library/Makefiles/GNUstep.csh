...
if ( ! ${?GNUSTEP_CONFIG_FILE} ) then
  setenv GNUSTEP_CONFIG_FILE "/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/etc/GNUstep/GNUstep.conf"
else
...
if ( "${GNUSTEP_MAKE_STRICT_V2_MODE}" == "yes" ) then
  ...
  if ( ! ${?GNUSTEP_SYSTEM_ROOT} ) then
    setenv GNUSTEP_SYSTEM_ROOT "/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System"
  endif

  if ( ! ${?GNUSTEP_LOCAL_ROOT} ) then
    setenv GNUSTEP_LOCAL_ROOT "/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Local"
  endif

  if ( ! ${?GNUSTEP_NETWORK_ROOT} ) then
    setenv GNUSTEP_NETWORK_ROOT "/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/Network"
  endif
...
if ( ! ${?GNUSTEP_MAKEFILES} ) then
  setenv GNUSTEP_MAKEFILES "/Users/heron/Development/gnustep/tools-scripts/.gnustep-build/System/Library/Makefiles"
endif
...
if ( "" == "" ) then
  setenv GNUSTEP_HOST "aarch64-apple-darwin25.3.0"
  setenv GNUSTEP_HOST_CPU "aarch64"
  setenv GNUSTEP_HOST_VENDOR "apple"
  setenv GNUSTEP_HOST_OS "darwin25"
endif
